...
<head>
    ...
    <style>
        .settings_navigation .settings_nav_links ul a:nth-child(5) li {
                ...
                <div class="settings_container">
                    ...
                    <div class="settings_main">
                        <div class="settings_main_top_panel">
                            <h1>Preferences</h1>
                            <p>Customize how the system looks and behaves based on your workflow.</p>
                        </div>
                        <hr>
                        <div class="settings_main_central_panel">
                            <div class="card_general">
                                <div class="card_general_profile" class="card_main">
                                    <div class="profile_text">             
                                        <p>General</p>
                                        <p class="p_settings">Basic preferences and app behavior.</p>
                                    </div>          
                            ...
                            <div class="card_general">
                                <div class="card_general_profile" class="card_main">
                                    <div class="profile_text">             
                                        <p>Appearance</p>
                                        <p class="p_settings">Theme, layout, and display options.</p>
                                    </div>          
                                    <div class="profile_more">
                                        <button onclick="this.closest('.card_general').querySelector('.dropdown_content').classList.toggle('show'); this.classList.toggle('rotate')"><img src="../../resources/img/icons/chevron_down.png" alt="chevron_down"></button>
                                    </div>
                            ...
                            <div class="card_general">
                                <div class="card_general_profile" class="card_main">
                                    <div class="profile_text">             
                                        <p>Notifications</p>
                                        <p class="p_settings">Manage alerts and message preferences.</p>
                                    </div>          
                                    <div class="profile_more">
                                        <button onclick="this.closest('.card_general').querySelector('.dropdown_content').classList.toggle('show'); this.classList.toggle('rotate')"><img src="../../resources/img/icons/chevron_down.png" alt="chevron_down"></button>
                                    </div>
