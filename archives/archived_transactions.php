...
<head>
    ...
    <style>
        ...
        .archive_nav_links a:nth-child(1) {
            background-color: var(--blue) !important;
            color: var(--main-content) !important;
            opacity: 1;
        }

        .archive_nav_links a:nth-child(1):hover {
            border: none;
            border-radius: 5px;
...
<body>
    ...
    <div class="result_cont_bar">
        <?php
            ...
            if (isset($_SESSION['req_success_msg'])) {
                echo "<span id=\"req_success\" class=\"message_success_d\"><img src=\"../resources/img/icons/check_g2.png\" alt=\"error\">" . $_SESSION['req_success_msg'] . "</span>";
                ...
                <script>
                    // Function to hide the element
                    function hideMessage() {
                        var element = document.getElementById('req_success');
                        if (element) {
                            // Use CSS opacity/transition for a smooth fade out (optional)
                            element.style.transition = 'opacity 0.5s ease-out';
                            element.style.opacity = '0';
                ...
                unset($_SESSION['req_success_msg']);
            }

            if (isset($_SESSION['req_error_msg'])) {
                echo "<span id=\"req_error\" class=\"message_success_d\"><img src=\"../resources/img/icons/error_bright.png\" alt=\"error\">" . $_SESSION['req_error_msg'] . "</span>";
                ...
                <script>
                    // Function to hide the element
                    function hideMessage() {
                        var element = document.getElementById('req_error');
                        if (element) {
                            // Use CSS opacity/transition for a smooth fade out (optional)
                            element.style.transition = 'opacity 0.5s ease-out';
                            element.style.opacity = '0';
