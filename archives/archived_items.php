...
<head>
    ...
    <style>
        ...
        .archive_nav_links a:nth-child(2) {
            background-color: var(--blue) !important;
            color: var(--main-content) !important;
            opacity: 1;
        }

        .archive_nav_links a:nth-child(2):hover {
            border: none;
            border-radius: 5px;
                    ...
                    <div class="data_tableC">
                        ...
                        <div class="data_panel_header">
                            ...
                            <div class="data_panel_buttonsC">
                                ...
                                ?>
                                <form action="archived_items.php" method="GET">
                                ...
                                <?php
                                    ...
                                    switch ($sorting)
                                    {
                                        case 'all':
                                        case 'default':
                                            $orderBy = " ORDER BY ia.agreement_num DESC";
                                            break;
                                        case 'pasig':
                                        ...
                                        case 'price_increasing': 
                                            $orderBy = " ORDER BY ia.principal ASC";
                                            break;
                                        case 'price_decreasing': 
                                            $orderBy = " ORDER BY ia.principal DESC";
                                            break;
                                        case 'active':
                                            $where[] = "ia.status = 'Active'";
                                            break;
                                        case 'overdue':
                                            $where[] = "ia.status = 'Overdue'";
                                            break;
                                        case 'redeemed':
                                            $where[] = "ia.status = 'Redeemed'";
                                            break;
                                        default:
                                            $orderBy = '';
                                            break;
                                    ...
                                    if($role != 'admin')
                                    {
                                        $where[] = "ia.branch_id = ?"; //If not admin, only display items from that branch
                                    }
                                    ...
                                    $sql = "SELECT ia.archive_id, ia.agreement_num, COALESCE(c.fullname, ca.fullname) AS fullname, ia.item_id, ia.client_id, ia.item_name, ia.principal, b.branch_name, ia.status, ia.due_date, ia.created_at
                                            ...
                                            if ($branch === "Marikina-Pasig") {
                                                ...
                                                if (isset($_SESSION['error_msg'])) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href=\"../archives/archived_item_details.php?id=" . $item_id . "\"><button><img src=\"../resources/img/icons/open.png\" alt=\"open\"></button></a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
